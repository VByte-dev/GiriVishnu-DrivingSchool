// 🟢 Driving School Services Section (with #15AB55 color theme)
...
const Services = () => {
  ...
  return (
    ...
    >
      {/* 🟩 Section Heading */}
      <h2
        className="font-[bricolage] text-transparent bg-gradient-to-b from-[#59ffa1] to-[#0b803d] bg-clip-text text-sm sm:text-base md:text-lg tracking-wide"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        Our Services
        ...
        {services.map((service, index) => (
          <div
            ...
            className="group rounded-2xl p-8 bg-white text-[#0B0C0E] shadow-lg 
                 ...
                 active:bg-gradient-to-b active:from-green-700 active:to-green-900"
            data-aos="zoom-in"
